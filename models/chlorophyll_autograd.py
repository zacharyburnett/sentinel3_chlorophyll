...
LOGGER = get_logger('chlorophyll.autograd', os.path.join(__file__, os.pardir, os.pardir, 'logs/chlorophyll_autograd.log'))
...
OUTPUT_TESTING_CSV_FILENAME = '../data/testing_output_autograd.csv'
